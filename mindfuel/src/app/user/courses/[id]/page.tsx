                  ...
                  {!user ? (
                    <div className="flex flex-col items-center gap-4">
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-center px-6 py-3 bg-gradient-to-r from-blue-600 to-indigo-600 hover:from-blue-500 hover:to-indigo-500 text-white font-medium rounded-lg transition-all duration-300 shadow-lg hover:shadow-blue-500/20"
                      >
                        Go to Login
                      </button>
                    </div>
